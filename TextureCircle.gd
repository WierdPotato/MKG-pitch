...
## Allows you to scale the outline texture
@export var outline_texture_scale := 1.0 : set = set_texture_scale
...
func set_texture_scale(value):
	outline_texture_scale = value
	set_texture_size()
...
func set_texture_outline(value):
	...
	if texture_outline != null:
		_texture_outline_size = texture_outline.get_size()*outline_texture_scale
